...
WORKDIR /go/src/github.com/AmitKumarDas/storage-provisioner
...
LABEL description="DDP Storage Provisioner"

COPY --from=builder /go/src/github.com/AmitKumarDas/storage-provisioner/d-storprovisioner d-storprovisioner
ENTRYPOINT ["/d-storprovisioner"]
