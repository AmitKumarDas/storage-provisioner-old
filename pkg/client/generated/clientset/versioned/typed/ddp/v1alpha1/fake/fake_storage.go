...
type FakeStorages struct {
	Fake *FakeDdpV1alpha1
	ns   string
}

var storagesResource = schema.GroupVersionResource{Group: "ddp.mayadata.io", Version: "v1alpha1", Resource: "storages"}

var storagesKind = schema.GroupVersionKind{Group: "ddp.mayadata.io", Version: "v1alpha1", Kind: "Storage"}
