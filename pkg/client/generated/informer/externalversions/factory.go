...
import (
	...
	ddp "github.com/AmitKumarDas/storage-provisioner/pkg/client/generated/informer/externalversions/ddp"
...
func (f *sharedInformerFactory) Ddp() ddp.Interface {
	return ddp.New(f, f.namespace, f.tweakListOptions)
}
